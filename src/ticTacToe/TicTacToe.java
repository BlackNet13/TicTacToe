package ticTacToe; //learn from tutorial with own added modifications: https://youtu.be/n8RWUoBcn3E?feature=shared
...
public class TicTacToe {
	...
	private void winningGame() {
		...
		if(b1!=10 && b2!=10 && b3!=10 && b4!=10 && b5!=10 && b6!=10 && b7!=10 && b8!=10 && b9!=10 && win!=true) {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("PLAYER 1 [X]");
		...
		xCount.setFont(new Font("Gadugi", Font.BOLD, 30));
		...
		JLabel lblNewLabel_1 = new JLabel("PLAYER 2 [O]");
		...
		oCount.setFont(new Font("Gadugi", Font.BOLD, 30));
		oCount.setText("0");
		...
		btnReset.setFont(new Font("Gadugi", Font.BOLD, 15));
		...
		btnExit.setFont(new Font("Gadugi", Font.BOLD, 15));
